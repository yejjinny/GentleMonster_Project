							...
							<nav class="n-nav">
								<ul class="n-nav__list inline">
									...
									<li class="n-nav__item">
										<a href="수정필" data-category="navigation" data-action="sunglasses" data-label="main-menu" class="n-nav__link font--kr font--13 font--bd" onclick="return delCurrentScroll();">선글라스</a>
									</li>
									<li class="n-nav__item">
									...
									<!-- 관리자  나중에 c:if 로 수정필-->
									<li class="n-nav__item" >
										<a href="수정필" style="color : blue !important;" data-category="navigation" data-action="stores" data-label="main-menu" class="n-nav__link font--kr font--13 font--bd">회원목록</a>
									</li>
									<li class="n-nav__item">
										<a href="수정필" style="color : blue !important;" data-category="navigation" data-action="stores" data-label="main-menu" class="n-nav__link font--kr font--13 font--bd">상품등록</a>
									</li>
									<li class="n-nav__item">
										<a href="수정필" style="color : blue !important;" data-category="navigation" data-action="stores" data-label="main-menu" class="n-nav__link font--kr font--13 font--bd">전체주문목록</a>
									</li>
									<!-- 관리자 끝 -->
								</ul>
							</nav>
								...
								<div class="n-header__cart float-left relative">
									<button data-toggle="modal" data-target="#cartModal" type="button">
										<span class="n-header__cart-icon"> <svg stroke="#545454" version="1.2" baseProfile="tiny" id="레이어_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 30 30" xml:space="preserve" aria-label="cart">
                                    		...
                                    		</svg> <span class="cart-count tab_cart_btn font--kr font--md">0</span>
										</span>
									</button>
								</div>
											...
											<div class="cart_item font--11 font--md">
												...
												<div class="cart_product_info">
													...
													<div class="cart_price">
														<span class="mini_cart_item_total_price font--kr font--12 font--rg"> <input type="hidden" value="${cartVo.price}" id="cartPrice${cartVo.cartId}" /> <fmt:formatNumber type="number" maxFractionDigits="3" value="${cartVo.price}" />원
														</span>
													</div>
