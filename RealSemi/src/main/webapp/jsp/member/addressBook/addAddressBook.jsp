			...
			<div class="edit-wrap text_l">
				...
				<div class="center-content center-content--wide">
					<form method="post" style="display: block" id="addressFormKr">
						<div>
							<input type="text" id="mb_adr_id" name="mb_adr_id" value="" hidden="">
						</div>
						...
						<div class="box-group box-group-child-2">
							<div class="input-box font--kr font--13 font--rg">
								...
								<input type="text" class="width_100  padding_10 font--kr font--13 font--rg" name="mb_lname" id="login_id" required="" size="20" maxlength="2" value="" placeholder="성"> <span class="_alert font--kr font--11 font--rg"></span>
							</div>
							<div class="input-box font--kr font--13 font--rg">
								<label class="input-label font--kr font--13 font--rg">이름</label>
								<input type="text" class="width_100  padding_10 font--kr font--13 font--rg" name="mb_fname" id="login_id" required="" size="20" maxlength="6" value="" placeholder="이름"> <span class="_alert font--kr font--11 font--rg"></span>
							</div>
						</div>

						<div class="input-box font--kr font--13 font--rg">
							<p class="input-label margin_b4 letter0 text_l font--kr font--13 font--rg">전화번호</p>
							<input type="text" id="mb_tel" name="mb_tel" class="width_100  padding_10 font--kr font--13 font--rg" required="" value=""> <span class="_alert font--kr font--11 font--rg"></span>
						</div>
						...
						<div class="input-box col-xs-margin-t-20">
							<div class="zip col-xs-12 input-box padding_0 col-xs-margin-b-20" hidden="">
								<div class="col-sm-9 col-sm-padding-l-0 col-sm-padding-r-10">
									...
									<input type="text" id="kr_postcode" name="zipcode" class="width_100  padding_10" value="" readonly=""> <span class="_alert font--kr font--11 font--rg"></span>
								</div>
							</div>
							<div class="input-box post_address font--kr font--13 font--rg">
								...
								<div id="postcodify" class="font--kr font--13 font--rg postcodify_search_form postcode_search_form" style="margin: 0px;">
									<div class="postcodify_search_controls postcode_search_controls" style="display: flex;">
										...
										<input type="text" class="keyword" value="" id="kr_address" placeholder="예) ㅇㅇ동, ㅇㅇ로" name="address1">
										<button type="button" class="search_button gm-component__spinner-container btn btn-black font--kr font--13 font--rg" id="postcodify_16970903331539114_button">검색</button>
							...
							<div class="input-box font--kr font--13 font--rg">
								...
								<input type="text" id="kr_detailAddress" class="width_100  padding_10 font--kr font--13 font--rg" required="" value="" name="address2" placeholder="상세주소"> <span class="_alert font--kr font--11 font--rg"></span>
							</div>
							...
							<div class="button-group">
								<button type="button" class="btn btn-black font--kr font--13 font--rg" onclick="checkAddressForm('create', 'kr')">저장</button>
							</div>
						</div>
					</form>
				</div>
