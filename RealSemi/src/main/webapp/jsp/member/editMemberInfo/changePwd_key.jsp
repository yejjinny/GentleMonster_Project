...
<script src="<%=ctxPath%>/js/member/editMemberInfo/changePwd_key.js" type="text/javascript"></script>
			...
			<div class="edit-wrap text_l">
				...
				<div class="center-content">
					<form name="changePassword" id="form_reset_password" action="" method="post">
						...
						<button id="button_reset_password" onclick="goPwdKey('<%=ctxPath%>')" type="button" class="btn btn-black font--kr font--13 font--rg" >비밀번호 변경</button>
					</form>
				</div>
			</div>
		</div>
