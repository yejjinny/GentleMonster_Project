									...
									<div class="input-box input-box-check mbtype01">
										<label for="privacy-policy"> <input type="checkbox" id="privacy-policy" name="privacy_policy" value="T">
											<div class="input-box-check-layer"></div> <span class="font--kr font--13  font--rg">
												<button type="button" class="link" data-toggle="modal" data-target="#legalModal">이용약관</button>, <button type="button" class="link"  data-toggle="modal" data-target="#privacyModal">개인정보 수집 및 이용</button> 에 동의합니다. (필수)
										</span>
										</label>
									</div>
