		...
		<div class="contentswrap_top center_wrap ">
			<div class="checkout">
				...
				<header class="checkout-header">
					...
					<a class="button button-link checkout-header-return font--kr font--13 font--rg size-reset atag-line" href="<%=ctxPath%>/index.gm"> 쇼핑 계속하기 </a>
				</header>
					...
					<div class="checkout-body checkout-body-block checkout-result resulttype01">
						...
						<ul class="checkout-summary">
							...
							<li class="checkout-summary-head checkout-summary-head--subtotal mbtype01">
								<span class="font--kr font--13 font--rg">상품합계</span> <span id="product_total_price" class="font--kr font--13 font--rg"></span>
							</li>
							<li class="checkout-summary-head mbtype01">
								<span class="font--kr font--13 font--rg">배송비</span> <span class="checkout-summary-price font--kr font--13 font--rg trans-reset">0원</span>
							</li>
							<li class="checkout-summary-head checkout-summary-head--total">
								<span class="font--kr font--13 font--rg">총합계</span> <span class="totalAmountIncludeShip checkout-summary-price font--kr font--13 font--rg"></span>
							</li>
							<li>
