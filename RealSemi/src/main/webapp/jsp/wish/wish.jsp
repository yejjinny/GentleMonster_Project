...
<link rel="stylesheet"
	href="<%=ctxPath%>/css/member/addressBook/addressBook.css">
...
<div class="container_sq">
	...
	<div
		class="contentswrap center_wrap  account wish-list edit kr container-1350">
			...
			<div class="edit-wrap text_l">
				<div class="head">
					<div class="title font--kr font--15 font--bd">
						위시리스트 <span id="list-total-count totalWishCount"
							class="font--en font--14">(${requestScope.totalWishCount})</span>
					</div>
				</div>
				<div id="product-list" class="product-list product-list-colunm4"
					data-infinite-scroll="" data-is-loading="false">
									...
									<div class="product">
										<div class="product__image-wrapper">
											<a class="product__link"
												href="<%= ctxPath %>/product/productDetail.gm?productDetailId=${wishVo.productDetailId}">
												<img data-src="" alt=""
												src="<%= ctxPath %>${wishVo.mainImageFile}">
											</a>
										</div>
										<div class="product__info relative">
											...
											<input type="hidden" name="it_id[]" value=""> <input
												type="hidden" name="tmpit_id[]" value=""> <input
												type="hidden" name="sw_direct"> <input type="hidden"
												name="url"> <input type="hidden" name="location"
												value="au"> <input type="hidden" name="ct_qty"
												value="1" class="frm_input" size="5"> <input
												type="hidden" name="io_type" value="0"> <input
												type="hidden" name="io_id" value=""> <input
												type="hidden" name="io_value" value=""> <input
												type="hidden" name="io_stock" value=""> <input
												type="hidden" name="io_qty" value=""> <input
												type="hidden" name="io_type_sub" value="1"> <input
												type="hidden" name="io_id_sub" value=""> <input
												type="hidden" name="io_value_sub" value=""> <input
												type="hidden" name="io_stock_sub" value=""> <input
												type="hidden" name="io_qty_sub" value="">
											<!--hidden 구간 재영-->
											...
											<c:if test="${wishVo.stock ne 0}">
												<form id="addCartItem${wishVo.productDetailId}"
													method="post" action="<%=ctxPath%>/cart/addCartItem.gm">
													<input type="hidden" name="productDetailId"
														value="${wishVo.productDetailId}">
													<button type="button"
														id="goToAddCart${wishVo.productDetailId}"
														class="addCartWish btn btn-black gm-component__spinner-container product__cart__btn">
														<div class="cart-loading gm-component__spinner-wrapper">
															<div class="gm-component__spinner dark"></div>
														</div>
														<span class="cart-text font--kr font--13 font--rg">쇼핑백에
															추가</span>
													</button>
												</form>
											</c:if>
											<div class="product-share">
												<button
													class="product__wish__btn jsBtnWish font--kr font--13 font--rg on"
													onclick="goDelete(${wishVo.wishId});">
